        ...
        <section class="advantages">
            ...
            <div class="advantages__wrapper">
                <div class="advantages__header">
                    <h2 class="advantages__title">Преимущества работы <br>с нами</h2>
                ...
                <div class="advantages__list">
                    <article class="advantage-card">
                        ...
                        <div class="advantage-card__content">
                            <h3 class="advantage-card__title">Быстрая доставка продукции</h3>
                    ...
                    <article class="advantage-card">
                        ...
                        <div class="advantage-card__content">
                            <h3 class="advantage-card__title">Комплексная поставка стройматериалов</h3>
                            <p class="advantage-card__description">
                    ...
                    <article class="advantage-card">
                        ...
                        <div class="advantage-card__content">
                            <h3 class="advantage-card__title">Широкий ассортимент продукции</h3>
                            <p class="advantage-card__description">
                    ...
                    <article class="advantage-card">
                        ...
                        <div class="advantage-card__content">
                            <h3 class="advantage-card__title">Вся продукция сертифицирована и&nbsp;соответствует ГОСТу
                            </h3>
                            <p class="advantage-card__description">
                ...
                <div class="buy-metal__bottom">
                    <div class="order">
                        <div class="order__left">
                            <h3 class="order__title">Как сделать заказ?</h3>
